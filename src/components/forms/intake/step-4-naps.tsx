...
export function Step4Naps() {
  ...
  const napDuration = useWatch({
    control,
    name: 'nap_duration',
    defaultValue: ''
  }) ?? ''
  const napMethod = useWatch({
    control,
    name: 'nap_method',
    defaultValue: ''
  }) ?? ''
  const napLocation = useWatch({
    control,
    name: 'nap_location',
    defaultValue: ''
  }) ?? ''
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <SelectWithOther
          ...
          value={napDuration}
          onChange={(value) => setValue('nap_duration', value, { shouldDirty: true, shouldValidate: true })}
        ...
        <SelectWithOther
          ...
          value={napMethod}
          onChange={(value) => setValue('nap_method', value, { shouldDirty: true, shouldValidate: true })}
        ...
        <SelectWithOther
          ...
          value={napLocation}
          onChange={(value) => setValue('nap_location', value, { shouldDirty: true, shouldValidate: true })}
